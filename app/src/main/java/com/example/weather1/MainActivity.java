    ...
    private class getURL extends AsyncTask<String, String, String>{
        ...
        protected void onPostExecute(String result){
            ...
            try {
                ...
                resultInfo.setText("Temperature: " + obj.getJSONObject("main").getDouble("temp") + " degrees Celsius" +
                        "\nFeels like: " + obj.getJSONObject("main").getDouble("feels_like") + " degrees Celsius" +
